...
[P] = plotArmAtPoint(X,Y,Z,theta,point,d,r);
plot3(point(1),point(2),point(3),'*r')
error(1) = norm(abs(point)-abs(P));
...
% 
%     if i == 1 
%         gif('Design1.gif','LoopCount',2,'frame',gcf) 
%     else 
%         gif 
%     end 
% end
...
legend('intersection points','approx. intersection circle','max. reachable points','required points','Location','northwest')
xlim([-280 410])
hold off
