...
%     if i==3
%     elseif i==4
%     	text(J(i+1).O(1)+10,J(i+1).O(2)+20,J(i+1).O(3),'3/4');
%     else
%         text(J(i+1).O(1)+10,J(i+1).O(2)+20,J(i+1).O(3),num2str(i));
%     end
end

% x = [J(1).O(1),J(2).O(1),J(3).O(1),J(4).O(1),J(5).O(1),J(6).O(1)];
% y = [J(1).O(2),J(2).O(2),J(3).O(2),J(4).O(2),J(5).O(2),J(6).O(2)];
% z = [J(1).O(3),J(2).O(3),J(3).O(3),J(4).O(3),J(5).O(3),J(6).O(3)];
